export const settingsDict = {
  ...
  'settings.openchamber.visual.field.plantumlTheme': 'PlantUML Theme',
  'settings.openchamber.visual.field.selectPlantumlThemeAria': 'Select PlantUML theme',
  'settings.openchamber.visual.option.plantumlTheme.none.label': 'Default',
  'settings.openchamber.visual.option.plantumlTheme.none.description': 'Default look, no theme applied.',
  'settings.openchamber.visual.option.plantumlTheme.plain.label': 'Plain',
  'settings.openchamber.visual.option.plantumlTheme.plain.description': 'Minimal flat styling.',
  'settings.openchamber.visual.option.plantumlTheme.mono.label': 'Mono',
  'settings.openchamber.visual.option.plantumlTheme.mono.description': 'Monochrome grayscale palette.',
  'settings.openchamber.visual.option.plantumlTheme.sunlust.label': 'Sunlust',
  'settings.openchamber.visual.option.plantumlTheme.sunlust.description': 'Warm, vibrant palette.',
  'settings.openchamber.visual.option.plantumlTheme.toy.label': 'Toy',
  'settings.openchamber.visual.option.plantumlTheme.toy.description': 'Playful high-contrast palette.',
  'settings.openchamber.visual.option.plantumlTheme.reddressLightblue.label': 'Red Dress Light Blue',
  'settings.openchamber.visual.option.plantumlTheme.reddressLightblue.description': 'Light theme with red and blue accents.',
