...
export const dict: Record<I18nKey, string> = {
  ...
  'markdown.toc.navAria': '目录',
  'markdown.toc.gotoHeadingAria': '跳转到 {heading}',
  'markdown.toc.collapseAria': '折叠 {heading}',
  'markdown.toc.expandAria': '展开 {heading}',
  'markdown.toc.openAria': '打开目录',
  ...
  'filesView.editor.toggleToc': '切换目录',
  ...
  'markdownRenderer.mermaid.actions.expandTitle': '全屏',
  'markdownRenderer.mermaid.toast.downloadFailed': '下载图表失败',
  'markdownRenderer.plantuml.status.loading': '正在渲染图表...',
  'markdownRenderer.plantuml.status.error': '无法渲染 PlantUML 图表。',
