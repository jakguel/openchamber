...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.toolOutputDialog.mermaid.zoomOutAria': '縮小',
  ...
  'sortableTabsStrip.aria.scrollLeft': '向左捲動分頁',
  'sortableTabsStrip.aria.scrollRight': '向右捲動分頁',
